...
SECRET_KEY = 'django-insecure-42k^!^-quf)$9^n#-!8kr4&3mb78q4l7puxkfby3y**@a60$2a'
...
# This connects 'static' folder with django
STATICFILES_DIRS = [
    BASE_DIR / 'static'
]
...
# This means we are going to allow all urls to access our api
